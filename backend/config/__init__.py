...
ENABLE_SCHEDULED_UPDATE_TGDB_DATABASE: Final = (
    os.environ.get("ENABLE_SCHEDULED_UPDATE_TGDB_DATABASE", "false") == "true"
)
SCHEDULED_UPDATE_TGDB_DATABASE_CRON: Final = os.environ.get(
